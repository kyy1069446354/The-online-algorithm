...
def Line_picmaker(line,length):
    ...
    plt.legend()
    # plt.savefig('small.eps',dpi=600,format='eps',bbox_inches = 'tight')
    # plt.savefig('big.eps',dpi=600,format='eps',bbox_inches = 'tight')
    # plt.savefig('bad1.eps', dpi=600, format='eps', bbox_inches='tight')
    plt.savefig('bad2.eps', dpi=600, format='eps', bbox_inches='tight')
    plt.clf()
    # plt.show()
...
def Bar_picmaker(line,time):
    ...
    plt.savefig('m='+str(m)+'.eps', dpi=600, format='eps',bbox_inches = 'tight')
# for i in range(10):
#     Bar_picmaker(100, 15)
...
def Box_picmaker(line,time):
    ...
    # plt.legend()
    plt.savefig('./'+'m='+str(m)+",SCPF="+str(SCPF)+",addPF="+str(addPF)+'all.eps',dpi=600,format='eps',bbox_inches = 'tight')
    plt.clf()
    # plt.show()
# for i in range(3):
...
def Swarm_picmaker(line,time):
    ...
    plt.xticks(fontsize=15)
    # plt.legend()
    plt.savefig('Totally_random.eps',dpi=600,format='eps',bbox_inches = 'tight')
    plt.clf()
    # plt.show()
#Swarm_picmaker(100, 300)
